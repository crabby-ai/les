...
use crate::errors::{Result, LessError};
use super::super::model::{
    BookTickers, KlineParams, KlineSummaries, KlineSummary, MarketPair,
    OrderBook, Prices, PriceStats, SymbolPrice, Ticker
};
        ...
        self.get_all_book_tickers().await.and_then(
            move |BookTickers::AllBookTickers(book_tickers)| {
                Ok(book_tickers
                    ...
                    .ok_or(LessError::SymbolNotFound())?)
            },
        )
    }
